...
from (values
  ...
  ('NHIE Party #12', 'NEVER_HAVE_I_EVER'::public.game_type, '{"statements":["Never have I ever said ''I''m leaving'' three times","Never have I ever switched seats to avoid someone","Never have I ever snuck past the VIP rope"],"voting":true,"realtime":true,"upsell_label":"Pay Penalty / Order Round","catalog_id":"g-nhie-12","weight":1.2,"min_group_size":3,"min_spend":0,"category":"NHIE","penalty_item":{"name":"Corona","quantity":1,"unit_price":380,"category":"BEER"}}'::jsonb, true),
  ...
  ('NHIE Party #18', 'NEVER_HAVE_I_EVER'::public.game_type, '{"statements":["Never have I ever paid for a round I didn''t drink","Never have I ever snuck past the VIP rope","Never have I ever taken a shot I regretted mid-swallow"],"voting":true,"realtime":true,"upsell_label":"Pay Penalty / Order Round","catalog_id":"g-nhie-18","weight":1.2,"min_group_size":3,"min_spend":0,"category":"NHIE","penalty_item":{"name":"Vodka Shot","quantity":1,"unit_price":260,"category":"SHOT"}}'::jsonb, true),
